			...
			<article className='group bg-white rounded-xl p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow duration-300 w-full'>
				...
				>
					...
					<div className='flex-grow'>
						...
						<h3 className='text-lg sm:text-xl font-bold mb-2 group-hover:text-pink-600 transition-colors duration-300'>
							{article.title}
						</h3>
						...
						<button className='text-sm sm:text-base text-pink-600 font-semibold hover:text-pink-500 transition-colors duration-300'>
							Read More →
						</button>
					</div>
				</div>
